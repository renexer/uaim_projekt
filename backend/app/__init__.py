...
def create_app(config_name=None):
    """Tworzy aplikację Flask i rejestruje rozszerzenia, blueprinty oraz obsługę błędów."""
    app = Flask(__name__)
    ...
    # Rozszerzenia są inicjalizowane w factory, dzięki czemu testy mogą tworzyć
    # osobną aplikację na izolowanej bazie SQLite, a Docker używa PostgreSQL.
    db.init_app(app)
    ...
    # Aktywne API jest wersjonowane prefiksem `/api/v1`.
